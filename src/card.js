...
(Card.prototype.overDraft = function (id) {
  ...
  this.$entryList.innerHTML += this.template.render([
    this.createOverdraftObject(id),
  ]);
}),
  /**
...
Card.prototype.changeBalance = function (transaction) {
  if (transaction) {
    this.getTransactionType(transaction) === "true"
      ? this.add(transaction)
      : transaction.transactionAmount > this.activeBalance
