...
(function () {
   ...
   */
  document
    .getElementById("closeTransactionForm")
    .addEventListener("click", function () {
      if (
        createTransaction.classList.contains("transaction-creation-modal--show")
      ) {
   ...
   */
  document
    .getElementById("transactionSubmit")
